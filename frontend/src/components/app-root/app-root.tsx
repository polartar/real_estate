    ...
    return [
      <ion-app>
          <ion-router useHash={false} onIonRouteDidChange={e => SEOService.update(e) }>
            ...
            <ion-route url={ RouterService.getRoute('neighborhoods') } component="page-neighborhoods" />
            <ion-route url="/nyc-neighborhood/:neighborhoodName/apartments" component="page-neighborhood" />
            ...
            <ion-route url={ RouterService.getRoute('privacy') } component="page-privacy" />

            <ion-route url={ RouterService.getRoute('private-rooms') } component="page-private-rooms" />
            <ion-route url={ RouterService.getRoute('corporate-rooms' )} component="page-corporate-rooms" />
