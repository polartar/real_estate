      ...
      <ion-content class="page-privacy">
        ...
        <section class="section">
          ...
          <ul>
              ...
              <li>
                  <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to APT212, 73 Spring street, New York NY 10012.</p>
              ...
              <li><strong>Website</strong> refers to APT212, accessible from https://apt212.com/</li>        <li><strong>Service</strong> refers to the Website.</li>
          ...
          <ul>
              <li>Email address</li>    <li>First name and last name</li>    <li>Phone number</li>    <li>Address, State, Province, ZIP/Postal code, City</li>    <li>Bank account information in order to pay for products and/or services within the Service</li>    <li>Usage Data</li>
          </ul>
          ...
          <ul>
        <li>By email: info@apt212.com</li>
        </ul>
        </section>
